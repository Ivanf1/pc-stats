...
class OhmPollingProcess(Process):
    def __init__(self, wmi_data_queue, polling_interval_secs, filter_wmi_data=None):
        self.polling_interval_secs = polling_interval_secs
        self.wmi_data_queue = wmi_data_queue
        self.filter_wmi_data = filter_wmi_data
    ...
    def run(self):
        try:
            ...
            while True:
                wmi_data = ohm.get_update(ohm_thread_wmi, self.filter_wmi_data)
